...
| -------------- | ------------------------------------------- | ------------------------------------- |
| **Todo-App**   | A personal task list application I built.   | 🔗 https://github.com                |
| **Poke-API**   | A simple and fun RESTful API about Pokémon. | 🔗 https://github.com                |
| **Bibliotech** | A complete application to manage books, users, loans. | 🔗 https://github.com      |
